...
class ComposeForm extends ImmutablePureComponent {
  static propTypes = {
    ...
    onSubmitPrivate: PropTypes.func,
    onSubmitUnlisted: PropTypes.func,
    onSubmitDirect: PropTypes.func,
  ...
  handleSubmit = (e) => {
    ...
    this.props.onSubmit({
      missingAltText:
        missingAltTextModal && this.props.missingAltText && this.props.privacy !== 'direct',
    ...
    return (
      <form className='compose-form' onSubmit={this.handleSubmit}>
        ...
        >
          ...
          <div className='compose-form__dropdowns compose-form__dropdowns--top'>
