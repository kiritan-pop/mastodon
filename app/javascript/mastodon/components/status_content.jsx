...
class StatusContent extends PureComponent {
  ...
  handleElement = (element, { key, ...props }, children) => {
    if (element instanceof HTMLAnchorElement) {
      const accountName = element.dataset.accountName || element.getAttribute('data-account-name');
      if (element.classList.contains('profile-emoji') && accountName) {
        return (
          <HandledLink
            {...props}
            href={`/${accountName}`}
        ...
        <>
          ...
          >
            <EmojiHTML
              ...
              lang={language}
              htmlString={content}
              extraEmojis={status.get('all_emojis')}
