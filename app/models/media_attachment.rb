...
class MediaAttachment < ApplicationRecord
  ...
  VIDEO_MIME_TYPES             = %w(video/webm video/mp4 video/quicktime video/ogg video/3gpp).freeze
  VIDEO_CONVERTIBLE_MIME_TYPES = %w(video/webm video/quicktime video/3gpp).freeze
